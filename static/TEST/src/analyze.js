    ...
    for (i = 0; i < length; i++) {
        ...
        if (message.test(lines[i].split(/(\s+)/)[0])) { //message
            ...
            if (membername != undefined) {
                if (!members.includes(membername) && (!membername.includes("收回訊息") && !membername.includes("邀請") && !membername.includes("加入") && !membername.includes("退出") && !membername.includes("已變更群組圖片") && !membername.includes("更改了群組圖片") && !membername.includes("通話") && !membername.includes("相簿") && !membername.includes("群組名稱") && !membername.includes("已讓") && !membername.includes("離開"))) {
                ...
                if ((!membername.includes("收回訊息") && !membername.includes("邀請") && !membername.includes("加入") && !membername.includes("退出") && !membername.includes("已變更群組圖片") && !membername.includes("更改了群組圖片") && !membername.includes("通話") && !membername.includes("相簿") && !membername.includes("群組名稱") && !membername.includes("已讓") && !membername.includes("離開"))) {
                    messageNumAll++;
                    totalMessages++;
                }
            }
...
function displayResult() {
    ...
    const member3Name = document.querySelector('[member3-name]')
    const member4Name = document.querySelector('[member4-name]')
    const member5Name = document.querySelector('[member5-name]')
    const member6Name = document.querySelector('[member6-name]')
    const member7Name = document.querySelector('[member7-name]')
    const member8Name = document.querySelector('[member8-name]')
    ...
    const member3Chart = document.querySelector('[member3-chart]')
    const member3Texts = document.querySelector('[member3-texts]')
    const member3Stickers = document.querySelector('[member3-stickers]')
    const member3Photos = document.querySelector('[member3-photos]')
    const member4Chart = document.querySelector('[member4-chart]')
    const member4Texts = document.querySelector('[member4-texts]')
    const member4Stickers = document.querySelector('[member4-stickers]')
    const member4Photos = document.querySelector('[member4-photos]')
    const member5Chart = document.querySelector('[member5-chart]')
    const member5Texts = document.querySelector('[member5-texts]')
    const member5Stickers = document.querySelector('[member5-stickers]')
    const member5Photos = document.querySelector('[member5-photos]')
    const member6Chart = document.querySelector('[member6-chart]')
    const member6Texts = document.querySelector('[member6-texts]')
    const member6Stickers = document.querySelector('[member6-stickers]')
    const member6Photos = document.querySelector('[member6-photos]')
    const member7Chart = document.querySelector('[member7-chart]')
    const member7Texts = document.querySelector('[member7-texts]')
    const member7Stickers = document.querySelector('[member7-stickers]')
    const member7Photos = document.querySelector('[member7-photos]')
    const member8Chart = document.querySelector('[member8-chart]')
    const member8Texts = document.querySelector('[member8-texts]')
    const member8Stickers = document.querySelector('[member8-stickers]')
    const member8Photos = document.querySelector('[member8-photos]')
    ...
    member3Name.textContent = members[2]
    member4Name.textContent = members[3]
    member5Name.textContent = members[4]
    member6Name.textContent = members[5]
    member7Name.textContent = members[6]
    member8Name.textContent = members[7]
    member1Message.textContent = eachMemberMessages[0] + ' 則'
    member2Message.textContent = eachMemberMessages[1] + ' 則'
    member3Message.textContent = eachMemberMessages[2] + ' 則'
    member4Message.textContent = eachMemberMessages[3] + ' 則'
    member5Message.textContent = eachMemberMessages[4] + ' 則'
    member6Message.textContent = eachMemberMessages[5] + ' 則'
    member7Message.textContent = eachMemberMessages[6] + ' 則'
    member8Message.textContent = eachMemberMessages[7] + ' 則'
    ...
    member3Chart.textContent = members[2]
    member3Texts.textContent = eachMemberMessages[2] - eachMemberStickers[2] - eachMemberPhotos[2] + ' 訊息'
    member3Stickers.textContent = eachMemberStickers[2] + ' 貼圖'
    member3Photos.textContent = eachMemberPhotos[2] + ' 照片'
    member4Chart.textContent = members[3]
    member4Texts.textContent = eachMemberMessages[3] - eachMemberStickers[3] - eachMemberPhotos[3] + ' 訊息'
    member4Stickers.textContent = eachMemberStickers[3] + ' 貼圖'
    member4Photos.textContent = eachMemberPhotos[3] + ' 照片'
    member5Chart.textContent = members[4]
    member5Texts.textContent = eachMemberMessages[4] - eachMemberStickers[4] - eachMemberPhotos[4] + ' 訊息'
    member5Stickers.textContent = eachMemberStickers[4] + ' 貼圖'
    member5Photos.textContent = eachMemberPhotos[4] + ' 照片'
    member6Chart.textContent = members[5]
    member6Texts.textContent = eachMemberMessages[5] - eachMemberStickers[5] - eachMemberPhotos[5] + ' 訊息'
    member6Stickers.textContent = eachMemberStickers[5] + ' 貼圖'
    member6Photos.textContent = eachMemberPhotos[5] + ' 照片'
    member7Chart.textContent = members[6]
    member7Texts.textContent = eachMemberMessages[6] - eachMemberStickers[6] - eachMemberPhotos[6] + ' 訊息'
    member7Stickers.textContent = eachMemberStickers[6] + ' 貼圖'
    member7Photos.textContent = eachMemberPhotos[6] + ' 照片'
    member8Chart.textContent = members[7]
    member8Texts.textContent = eachMemberMessages[7] - eachMemberStickers[7] - eachMemberPhotos[7] + ' 訊息'
    member8Stickers.textContent = eachMemberStickers[7] + ' 貼圖'
    member8Photos.textContent = eachMemberPhotos[7] + ' 照片'
